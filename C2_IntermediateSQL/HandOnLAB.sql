...
-- Practice Questions: Hand On LAB
...
-- 3. Group the records in terms of the department IDs and filter them of ones that have 
---   average salary more than or equal to 60000. Display the department ID and the average salary.
